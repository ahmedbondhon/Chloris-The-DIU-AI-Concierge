...
1. **No Repetitive Greetings**: Only greet the user (e.g., "Hello", "Hi") if it's the very beginning of a conversation. If you've already greeted them, just jump straight into the conversation or answer.
